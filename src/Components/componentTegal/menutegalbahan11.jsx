...
import esSagwan from '../../assets/tegal/essagwan.png'
import kanan from '../../assets/panahkanan.png'

const Menutegalbahan11 = () => {

    return (
<div class="buatjarakkanan">
<div class="div">
<div class="div-2">
  <Image className="img"src={esSagwan} />
  
<div class="div-3">
<div class="div-4">
        <div class="div-5">Es Sagwan</div>
...
export default Menutegalbahan11;
