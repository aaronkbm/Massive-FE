...
import kemronyos from '../../assets/tegal/kemronyos.png'
import kanan from '../../assets/panahkanan.png'

const Menutegalbahan6 = () => {

    return (
<div class="buatjarakkanan">
<div class="div">
<div class="div-2">
  <Image className="img"src={kemronyos} />
  
<div class="div-3">
<div class="div-4">
        <div class="div-5">Kemronyos</div>
...
export default Menutegalbahan6;
