...
import kupatGlabed from '../../assets/tegal/kupatglabed.png'
import kanan from '../../assets/panahkanan.png'

const Menutegalbahan2 = () => {

    return (
<div class="buatjarakkanan">
<div class="div">
<div class="div-2">
  <Image className="img"src={kupatGlabed} />
  
<div class="div-3">
<div class="div-4">
        <div class="div-5">Kupat Glabed</div>
...
export default Menutegalbahan2;
