...
import Lenjongan from '../../assets/solo/lenjongan.png'



const Menusolobahan6 = () => {

    return (
<div class="buatjarakkanan">
<div class="div">
<div class="div-2">
  <Image className="img"src={Lenjongan} />
  
<div class="div-3">
<div class="div-4">
        <div class="div-5">Lenjongan</div>
