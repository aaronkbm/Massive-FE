...
import tehKampul from '../../assets/solo/tehkampul.png'



const Menusolobahan13 = () => {

    return (
<div class="buatjarakkanan">
<div class="div">
<div class="div-2">
  <Image className="img"src={tehKampul} />
  
<div class="div-3">
<div class="div-4">
        <div class="div-5">Teh Kampul</div>
...
export default Menusolobahan13;
