...
import wedangTahu from '../../assets/semarang/wedangtahu.png'
import kanan from '../../assets/panahkanan.png'

const Menusemarangbahan9 = () => {

    return (
<div class="buatjarakkanan">
<div class="div">
<div class="div-2">
  <Image className="img"src={wedangTahu} />
  
<div class="div-3">
<div class="div-4">
        <div class="div-5">Wedang Tahu</div>
...
export default Menusemarangbahan9;
