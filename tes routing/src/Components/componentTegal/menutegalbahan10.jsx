...
import esdawetBeras from '../../assets/tegal/esdawetberas.png'
import kanan from '../../assets/panahkanan.png'

const Menutegalbahan10 = () => {

    return (
<div class="buatjarakkanan">
<div class="div">
<div class="div-2">
  <Image className="img"src={esdawetBeras} />
  
<div class="div-3">
<div class="div-4">
        <div class="div-5">Es Dawet Beras</div>
...
export default Menutegalbahan10;
