...
import rujakTeplak from '../../assets/tegal/rujakteplak.png'
import kanan from '../../assets/panahkanan.png'

const Menutegalbahan1 = () => {

    return (
<div class="buatjarakkanan">
<div class="div">
<div class="div-2">
  <Image className="img"src={rujakTeplak} />
  
<div class="div-3">
<div class="div-4">
        <div class="div-5">Rujak Teplak</div>
...
export default Menutegalbahan1;
