...
import esLontrong from '../../assets/tegal/eslontrong.png'
import kanan from '../../assets/panahkanan.png'

const Menutegalbahan9 = () => {

    return (
<div class="buatjarakkanan">
<div class="div">
<div class="div-2">
  <Image className="img"src={esLontrong} />
  
<div class="div-3">
<div class="div-4">
        <div class="div-5">Es Lontrong</div>
...
export default Menutegalbahan9;
