...
import esCao from '../../assets/semarang/escao.png'
import kanan from '../../assets/panahkanan.png'

const Menusemarangbahan11 = () => {

    return (
<div class="buatjarakkanan">
<div class="div">
<div class="div-2">
  <Image className="img"src={esCao} />
  
<div class="div-3">
<div class="div-4">
        <div class="div-5">Es Cao</div>
...
export default Menusemarangbahan11;
