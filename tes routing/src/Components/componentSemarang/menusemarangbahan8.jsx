...
import esPuter from '../../assets/semarang/esputer.png'
import kanan from '../../assets/panahkanan.png'

const Menusemarangbahan8 = () => {

    return (
<div class="buatjarakkanan">
<div class="div">
<div class="div-2">
  <Image className="img"src={esPuter} />
  
<div class="div-3">
<div class="div-4">
        <div class="div-5">Es Puter</div>
...
export default Menusemarangbahan8;
