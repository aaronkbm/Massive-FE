...
import esMarem from '../../assets/semarang/esmarem.png'
import kanan from '../../assets/panahkanan.png'

const Menusemarangbahan12 = () => {

    return (
<div class="buatjarakkanan">
<div class="div">
<div class="div-2">
  <Image className="img"src={esMarem} />
  
<div class="div-3">
<div class="div-4">
        <div class="div-5">Es Marem</div>
...
export default Menusemarangbahan12;
